...
public class FirmaDigitalPdf {
    ...
    public byte[] firmar(KeyStore keyStore, byte[] documento, String clave) throws Exception {
        ...
        for (Alias alias : signingAliases) {
            System.out.println("firmando2 "+alias.getAlias());
            PrivateKey pk = (PrivateKey) keyStore.getKey(alias.getAlias(), null);
            System.out.println("firmando2.1");
